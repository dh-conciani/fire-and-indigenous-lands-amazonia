...
var collection = ee.Image('projects/mapbiomas-workspace/public/collection7_1/mapbiomas-fire-collection2-fire-frequency-1');

// define the years to bem computed 
//var years = ee.List.sequence({'start': 1985, 'end': 2022, 'step': 1}).getInfo();
var years = ['1985_2022', '1985_1994', '1995_2004', '2005_2014', '2015_2022'];
// *-- 
...
var computed = territories.map(function(image) {
  ...
  var areas = years.map(
      function (year) {
          var image = collection.select('fire_frequency_' + year);
...
Export.table.toDrive({
      ...
      description: 'AREAS-IND-LANDS-FIRE-FREQUENCY',
      folder: driverFolder,
      fileFormat: 'CSV'
});
